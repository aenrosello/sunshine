...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherAsync extends AsyncTask<String, Void, String[]> {
        ...
        /**
         * Get a JSON with weather information from OpenWeather.org, using
         * {@link java.net.HttpURLConnection}.
         *
         * @return {@link String} in a JSON format with the weather information, or null
        ...
        public String[] getWeatherForecast(String... params) {
            ...
            try {
                ...
                // If the code didn't successfully get the weather dat"PlaceholderFragment"a, there's no point in attemping
                // to parse it.
                return null;
            } finally {
        ...
        */
        ...
        protected void onPostExecute(String[] forecastResult) {
            ...
            if (forecastResult != null && forecastResult.length > 0) {
                forecastAdapter.addAll(forecastResult);
            }
        }
    }
}
